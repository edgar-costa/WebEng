...
-->
	...
	<section class="skills sectionPadding slideInBottom">
			...
			<div class="skill_sqr" > <div id="html_skill"><div class="skill_percentage"><?php  echo strval(get_option("html_skill")) ?><span>%</span></div> <div class="skill_name">HTML</div></div></div>
			<div class="skill_sqr" >  <div id="css_skill" ><div class="skill_percentage"><?php  echo strval(get_option("css_skill")) ?><span>%</span></div> <div class="skill_name" >CSS</div></div></div>
			<div class="skill_sqr"  > <div id="js_skill" ><div class="skill_percentage"><?php  echo strval(get_option("js_skill")) ?><span>%</span></div> <div class="skill_name">JavaScript</div> </div></div>
			<div class="skill_sqr" > <div  id="wp_skill"> <div class="skill_percentage"><?php  echo strval(get_option("wp_skill")) ?><span>%</span></div> <div class="skill_name">WordPress</div> </div></div>
	</section>
    </section>
